...
-----------------------------------------------------------------------------*/
	...
	if( file_exists( LIBDIR . DIRECTORY_SEPARATOR . "db" . DIRECTORY_SEPARATOR . "sqlite3_pdo.php" ) )
	{
		require_once LIBDIR . DIRECTORY_SEPARATOR . "db" . DIRECTORY_SEPARATOR . "sqlite3_pdo.php";
	}
